...
import in.novopay.cbs.ui_pages.GeneralLedgerListPage;
import in.novopay.cbs.utils.BasePage;
import io.appium.java_client.MobileElement;
import io.appium.java_client.android.AndroidDriver;

public class GLPageTest {
	public AndroidDriver<MobileElement> mdriver;
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private GeneralLedgerListPage glPage;
	public String sheetname = "GLPage", workbook = "UITestData";

	public void gLPageTest(HashMap<String, String> usrData) {
		...
		if (testOn.toUpperCase().equals("MOBILE")) {
			...
			glPage = new GeneralLedgerListPage(wdriver);
			glPage.generalLedgerTest(usrData);
		}
	}
}
